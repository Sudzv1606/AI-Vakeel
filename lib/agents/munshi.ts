...
- Section 39: Relief powers of District Commission. MUST CITE. This is the section that empowers the Commission to order refund/replacement/compensation.
...
Respond with ONLY numbered paragraphs. No JSON, no explanation.`;
  ...
  private buildConsumerSkeleton(
    ...
    // Calculate litigation costs programmatically
    const litigationCosts = facts.financialClaims?.total
      ? `₹${Math.round(Math.min(5000, facts.financialClaims.total * 0.05) / 500) * 500 || 500}`
      : '₹5,000';
...
4. Litigation costs of ${litigationCosts}
...
**DISCLAIMER:** This document was generated by AI Vakeel, an AI-powered legal document generator. It is NOT legal advice and does not constitute the practice of law. The user must verify all facts, section citations, and formatting before filing. Consult a licensed advocate for legal guidance. AI Vakeel bears no responsibility for the accuracy or legal consequences of this document.`;
  }
...
**DISCLAIMER:** This document was generated by AI Vakeel, an AI-powered legal document generator. It is NOT legal advice and does not constitute the practice of law. The user must verify all facts, section citations, and formatting before filing. Consult a licensed advocate for legal guidance. AI Vakeel bears no responsibility for the accuracy or legal consequences of this document.`;
  ...
  private buildDocumentStructure(
    ...
    if (domainKey === 'CONSUMER') {
      ...
      prayerClause = `1. Refund of ${refund}\n2. Compensation of ${compensation} for mental agony and harassment\n3. Interest at 9% per annum from ${firstDate} until realization\n4. Litigation costs of ₹${facts.financialClaims?.total ? Math.round(Math.min(5000, facts.financialClaims.total * 0.05) / 500) * 500 || 500 : 5000}\n5. Any other relief this Hon'ble Commission deems fit`;
